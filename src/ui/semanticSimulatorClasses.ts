...
export const SIM_PHONE_CONTACT_ROW_MAIN = 'simulator-phone__contact-row-main';
export const SIM_PHONE_CONTACT_ROW_NAME = 'simulator-phone__contact-row-name';
export const SIM_PHONE_CONTACT_ROW_NUMBER = 'simulator-phone__contact-row-number';
